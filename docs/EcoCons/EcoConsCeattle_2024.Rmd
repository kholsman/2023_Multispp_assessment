...
Patterns in the total biomass of each species consumed by all three predators in the model (typically 1-3 yr old fish) exhibit divergent trends from predation mortality in `r thisYr`. Pollock biomass consumed by all predators in the model is above the long-term mean (indicating more pollock were consumed in the last few years than on average), while P. cod consumed is approximately the mean, and arrowtooth consumed is trending downward (Fig. 2).
